...
void SBomber::DropClasterBomb()
{
    if (bombsNumber > 0)
    {
        ...
        if (bombsNumber>0)
        {
            Bomb* pCBomb = pBomb->ClastBomb();
            pCBomb->SetPos(x + 2, y);
            pCBomb->SetSpeed(1);
            vecDynamicObj.push_back(pCBomb);

            Bomb* pClastBomb = pBomb->ClastBomb();
            pClastBomb->SetPos(x+2,y);
            pCBomb->SetSpeed(1);
            vecDynamicObj.push_back(pClastBomb);

            Bomb* pClBomb = pBomb->ClastBomb();
            pClastBomb->SetPos(x-2, y);
            pCBomb->SetSpeed(1);
            vecDynamicObj.push_back(pClastBomb);
