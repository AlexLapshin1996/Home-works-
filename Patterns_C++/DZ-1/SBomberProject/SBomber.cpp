...
SBomber::SBomber()
    ...
    score(0)
{
    Singleton::GetInstance().WriteToLog(string(__FUNCTION__) + " was invoked");
...
void SBomber::ProcessKBHit()
{
    ...
    Singleton::GetInstance().WriteToLog(string(__FUNCTION__) + " was invoked. key = ", c);
...
void SBomber::TimeFinish()
{
    ...
    Singleton::GetInstance().WriteToLog(string(__FUNCTION__) + " deltaTime = ", (int)deltaTime);
}
