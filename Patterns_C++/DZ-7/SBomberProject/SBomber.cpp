...
SBomber::SBomber()
    ...
    score(0)
{
    GlobalLogger.WriteToLog(string(__FUNCTION__) + " was invoked");
...
void SBomber::ProcessKBHit()
{
    ...
    GlobalLogger.WriteToLog(string(__FUNCTION__) + " was invoked. key = ", c);
...
void SBomber::TimeFinish()
{
    ...
    GlobalLogger.WriteToLog(string(__FUNCTION__) + " deltaTime = ", (int)deltaTime);
}
